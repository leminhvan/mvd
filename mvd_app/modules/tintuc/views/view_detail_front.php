                        ...
                        <div class="col-lg-8 post-list">
                            ...
                            <div class="single-post-wrap">
                                <div class="feature-img-thumb relative">
                                    ...
                                    <img class="img-fluid" src="<?php echo base_url(); ?>assets/tintuc/img/f1.jpg" alt="">
                                </div>
                                <div class="content-wrap">
                                    <ul class="tags mt-10">
                                        <li><a href="#"><?php echo $tintuc['ten_dm']; ?></a></li>
                                    </ul>
                                    <a href="#">
                                        ...
                                        <div class="row flex-column">
                                            ...
                                            <div class="comment-list">
                                                <div class="single-comment justify-content-between d-flex">
                                                    <div class="user justify-content-between d-flex">
                                                        <div class="thumb">
                                                            <img src="<?php echo base_url(); ?>assets/tintuc/img/blog/c1.jpg" alt="">
                                                        </div>
                                                        <div class="desc">
                                            ...
                                            <div class="comment-list left-padding">
                                                <div class="single-comment justify-content-between d-flex">
                                                    <div class="user justify-content-between d-flex">
                                                        <div class="thumb">
                                                            <img src="<?php echo base_url(); ?>assets/tintuc/img/blog/c2.jpg" alt="">
                                                        </div>
                                                        <div class="desc">
                                                            <h5><a href="#">Emilly Blunt</a></h5>
                                                            <p class="date">December 4, 2017 at 3:12 pm </p>
                                            ...
                                            <div class="comment-list">
                                                <div class="single-comment justify-content-between d-flex">
                                                    <div class="user justify-content-between d-flex">
                                                        <div class="thumb">
                                                            <img src="<?php echo base_url(); ?>assets/tintuc/img/blog/c3.jpg" alt="">
                                                        </div>
                                                        <div class="desc">
                                                            <h5><a href="#">Emilly Blunt</a></h5>
                                                            <p class="date">December 4, 2017 at 3:12 pm </p>
                    ...
                    <div class="col-lg-4">
                        <div class="sidebars-area">
                                ...
                                <div class="editors-pick-post">
                                    <div class="feature-img-wrap relative">
                                        <div class="feature-img relative">
                                            <div class="overlay overlay-bg"></div>
                                            <img class="img-fluid" src="<?php echo base_url(); ?>assets/tintuc/img/e1.jpg" alt="">
                                        </div>
                                        <ul class="tags">
                                    ...
                                    <div class="post-lists">
                                        <div class="single-post d-flex flex-row">
                                            <div class="thumb">
                                                <img src="<?php echo base_url(); ?>assets/tintuc/img/e2.jpg" alt="">
                                            </div>
                                            <div class="detail">
                                        ...
                                        <div class="single-post d-flex flex-row">
                                            <div class="thumb">
                                                <img src="<?php echo base_url(); ?>assets/tintuc/img/e3.jpg" alt="">
                                            </div>
                                            <div class="detail">
                                        ...
                                        <div class="single-post d-flex flex-row">
                                            <div class="thumb">
                                                <img src="<?php echo base_url(); ?>assets/tintuc/img/e4.jpg" alt="">
                                            </div>
                                            <div class="detail">
                            ...
                            <div class="single-sidebar-widget ads-widget">
                                <img class="img-fluid" src="<?php echo base_url(); ?>assets/tintuc/img/sidebar-ads.jpg" alt="">
                            </div>
