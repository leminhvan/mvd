...
<div class="card" >
    ...
    <div class="card-body card-padding">
        ...
        <div class="row">
            <div class="col-xs-2 text-center"><h5><?php echo lang('mau_chitieu'); ?></h5></div>
            ...
            <div class="col-xs-3 text-center"><h5><?php echo lang('mau_note'); ?></h5></div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-2">
                <div class="fg-line form-group">
                    <input type="text" class="form-control input-sm  autoten typehead " required name="mau_chitieu[]" placeholder="<?php echo lang('mau_chitieu').' '.$i; ?>">
                </div>
            </div>
            <div class="col-xs-2">
                <div class="fg-line form-group">
            ...
            <div class="col-xs-1">
                    <div class="select">                                
                         ...
                         // if(count($donvi) >1){
                          ...
                          //}
                          // else{
                           // echo form_dropdown('mau_donvi[]','%', 'mg', 'class = "form-control "');   
                          //}              
                          ?>
